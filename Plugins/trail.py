...
class TrailWindow(ba.Window):
    ...
    def __init__(self,
        ...
        if self._width == 1040:
            ...
            extraa = 0
        self._text = ba.textwidget(parent=self._root_widget, position=(self._width*0.065+extraa+extra_x*4,self._height*0.35-extra_x*0.6),color=(1,1,1),editable=True,max_chars= 7,description="Custom Trails",scale=0.9, size=(500, 50),maxwidth=800, max_height=80, h_align='center',v_align='center', text=ba.app.config["Trails"]["custom"])
